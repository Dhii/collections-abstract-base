...
class AbstractCollectionTest extends \Xpmock\TestCase
{
    ...
    {
        $mock = $this->mock('Dhii\\Collection\\AbstractAccessibleMutableCollection')
                ->_validateItem()
                ->new();
    ...
    public function testCanBeCreated()
    {
        ...
        $this->assertInstanceOf('Dhii\\Collection\\AbstractAccessibleMutableCollection', $subject, 'Subject is not of the right type');
    }
